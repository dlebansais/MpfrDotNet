namespace MpfrDotNet
{
    ...
    public static partial class mpfr
    {
        ...
        {
            return mpfr_add(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_add_ui(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_add_si(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_add_d(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_add_z(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sub(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_ui_sub(ref rop.Value, op1, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sub_ui(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_si_sub(ref rop.Value, op1, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sub_si(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_d_sub(ref rop.Value, op1, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sub_d(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_z_sub(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sub_z(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sub_q(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        #endregion
        ...
        {
            return mpfr_mul(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_ui(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_2ui(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_2si(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_si(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_d(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_z(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_q(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        #endregion
        ...
        {
            return mpfr_div(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_ui_div(ref rop.Value, op1, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_ui(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_2ui(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_2si(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_si_div(ref rop.Value, op1, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_si(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_d_div(ref rop.Value, op1, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_d(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_z(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_q(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        #endregion
        ...
        {
            return mpfr_sqr(ref rop.Value, ref op.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sqrt(ref rop.Value, ref op.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_sqrt_ui(ref rop.Value, op, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_rec_sqrt(ref rop.Value, ref op.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_cbrt(ref rop.Value, ref op.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_neg(ref rop.Value, ref op.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_abs(ref rop.Value, ref op.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_dim(ref rop.Value, ref op1.Value, ref op2.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_fac_ui(ref rop.Value, op, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_fma(ref rop.Value, ref op1.Value, ref op2.Value, ref op3.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_fms(ref rop.Value, ref op1.Value, ref op2.Value, ref op3.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_fmma(ref rop.Value, ref op1.Value, ref op2.Value, ref op3.Value, ref op4.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_fmms(ref rop.Value, ref op1.Value, ref op2.Value, ref op3.Value, ref op4.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_hypot(ref rop.Value, ref x.Value, ref y.Value, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_mul_2exp(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        ...
        {
            return mpfr_div_2exp(ref rop.Value, ref op1.Value, op2, (__mpfr_rnd_t)rnd);
        }
        #endregion
    }
}
