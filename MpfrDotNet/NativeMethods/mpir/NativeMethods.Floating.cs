namespace MpirDotNet
{
    ...
    internal static partial class NativeMethods
    {
        ...
        public static __mpf_inits mpf_inits = Marshal.GetDelegateForFunctionPointer<__mpf_inits>(GetMpirPointer(nameof(mpf_inits)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpf_clear(ref __mpf_t x);
        public static __mpf_clear mpf_clear = Marshal.GetDelegateForFunctionPointer<__mpf_clear>(GetMpirPointer(nameof(mpf_clear)));
        ...
        public static __mpf_set_d mpf_set_d = Marshal.GetDelegateForFunctionPointer<__mpf_set_d>(GetMpirPointer(nameof(mpf_set_d)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpf_set_z(ref __mpf_t rop, ref __mpz_t op);
        public static __mpf_set_z mpf_set_z = Marshal.GetDelegateForFunctionPointer<__mpf_set_z>(GetMpirPointer(nameof(mpf_set_z)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpf_set_q(ref __mpf_t rop, ref __mpq_t op);
        public static __mpf_set_q mpf_set_q = Marshal.GetDelegateForFunctionPointer<__mpf_set_q>(GetMpirPointer(nameof(mpf_set_q)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public delegate int __mpf_set_str(ref __mpf_t rop, string str, uint strbase);
        public static __mpf_set_str mpf_set_str = Marshal.GetDelegateForFunctionPointer<__mpf_set_str>(GetMpirPointer(nameof(mpf_set_str)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpf_swap(ref __mpf_t rop1, ref __mpf_t rop2);
        public static __mpf_swap mpf_swap = Marshal.GetDelegateForFunctionPointer<__mpf_swap>(GetMpirPointer(nameof(mpf_swap)));
        #endregion
        ...
        public static __mpf_init_set_d mpf_init_set_d = Marshal.GetDelegateForFunctionPointer<__mpf_init_set_d>(GetMpirPointer(nameof(mpf_init_set_d)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public delegate int __mpf_init_set_str(ref __mpf_t rop, string str, uint strbase);
        public static __mpf_init_set_str mpf_init_set_str = Marshal.GetDelegateForFunctionPointer<__mpf_init_set_str>(GetMpirPointer(nameof(mpf_init_set_str)));
        #endregion
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate long __mpf_get_si(ref __mpf_t op);
        ...
        public static __mpf_neg mpf_neg = Marshal.GetDelegateForFunctionPointer<__mpf_neg>(GetMpirPointer(nameof(mpf_neg)));
        ...
        public static __mpf_cmp mpf_cmp = Marshal.GetDelegateForFunctionPointer<__mpf_cmp>(GetMpirPointer(nameof(mpf_cmp)));
        ...
        public static __mpf_reldiff mpf_reldiff = Marshal.GetDelegateForFunctionPointer<__mpf_reldiff>(GetMpirPointer(nameof(mpf_reldiff)));
        ...
        public static __mpf_ceil mpf_ceil = Marshal.GetDelegateForFunctionPointer<__mpf_ceil>(GetMpirPointer(nameof(mpf_ceil)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpf_floor(ref __mpf_t rop, ref __mpf_t op);
        public static __mpf_floor mpf_floor = Marshal.GetDelegateForFunctionPointer<__mpf_floor>(GetMpirPointer(nameof(mpf_floor)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpf_trunc(ref __mpf_t rop, ref __mpf_t op);
        public static __mpf_trunc mpf_trunc = Marshal.GetDelegateForFunctionPointer<__mpf_trunc>(GetMpirPointer(nameof(mpf_trunc)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpf_integer_p(ref __mpf_t op);
        public static __mpf_integer_p mpf_integer_p = Marshal.GetDelegateForFunctionPointer<__mpf_integer_p>(GetMpirPointer(nameof(mpf_integer_p)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpf_fits_ulong_p(ref __mpf_t op);
        public static __mpf_fits_ulong_p mpf_fits_ulong_p = Marshal.GetDelegateForFunctionPointer<__mpf_fits_ulong_p>(GetMpirPointer(nameof(mpf_fits_ulong_p)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpf_fits_slong_p(ref __mpf_t op);
        public static __mpf_fits_slong_p mpf_fits_slong_p = Marshal.GetDelegateForFunctionPointer<__mpf_fits_slong_p>(GetMpirPointer(nameof(mpf_fits_slong_p)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpf_fits_uint_p(ref __mpf_t op);
        public static __mpf_fits_uint_p mpf_fits_uint_p = Marshal.GetDelegateForFunctionPointer<__mpf_fits_uint_p>(GetMpirPointer(nameof(mpf_fits_uint_p)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpf_fits_sint_p(ref __mpf_t op);
        public static __mpf_fits_sint_p mpf_fits_sint_p = Marshal.GetDelegateForFunctionPointer<__mpf_fits_sint_p>(GetMpirPointer(nameof(mpf_fits_sint_p)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpf_fits_ushort_p(ref __mpf_t op);
        public static __mpf_fits_ushort_p mpf_fits_ushort_p = Marshal.GetDelegateForFunctionPointer<__mpf_fits_ushort_p>(GetMpirPointer(nameof(mpf_fits_ushort_p)));
