...
public class MiscArithmetic
{
    ...
    public void EuclieanNorm()
    {
        ...
        AsString = a.ToString();
        Assert.That(AsString, Is.EqualTo("8.650279350142877E+15"));
        ...
        AsString = c.ToString();
        Assert.That(AsString, Is.EqualTo("8.933066242693924E+15"));
    }
    ...
    public void Factorial()
    {
        ...
        AsString = b.ToString();
        Assert.That(AsString, Is.EqualTo("6.7030370457971507477756421807177227647562122526821094E+1093158"));
